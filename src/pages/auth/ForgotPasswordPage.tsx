...
export const ForgotPasswordPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setSent(true);
      setIsLoading(false);
      success('Instruções de recuperação enviadas com sucesso!');
    }, 600);
  };
    ...
    <div className="min-h-screen bg-slate-100 flex flex-col justify-center items-center p-4 sm:p-6">
      ...
      <Card className="w-full max-w-md shadow-elevated border-slate-200">
        <CardHeader className="text-center pb-4">
          ...
          <CardDescription>
            Digite o e-mail cadastrado da sua oficina para redefinir o acesso.
          </CardDescription>
        </CardHeader>
        ...
        <CardContent>
          {sent ? (
            <div className="text-center py-4 space-y-4">
              ...
              <p className="text-xs font-mono text-slate-600 bg-slate-50 p-2 rounded-lg border">
                {email}
              </p>
