...
import { Wrench, Mail, Lock, Sparkles } from 'lucide-react';
...
export const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!ok) {
        error('E-mail ou senha inválidos. Confira também se o e-mail já foi confirmado.');
        return;
      }
  ...
  const handleQuickDemo = () => {
    loginDemo();
    success('Acessando a oficina modelo em modo demonstração.');
    navigate('/dashboard');
  };
    ...
    <div className="min-h-screen bg-slate-100 flex flex-col justify-center items-center p-4 sm:p-6">
      <div className="flex items-center gap-2.5 mb-6">
        ...
        <div>
          ...
          <span className="text-xs text-primary-600 font-bold uppercase tracking-wider">Gestão Automotiva Simplificada</span>
        </div>
      </div>
      ...
      <Card className="w-full max-w-md shadow-elevated border-slate-200">
        <CardHeader className="text-center pb-4">
          ...
          <CardDescription>Entre com suas credenciais para gerenciar seus orçamentos e serviços.</CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-4">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-end text-xs">
              <Link to="/forgot-password" className="text-primary-600 font-semibold hover:underline">Esqueceu a senha?</Link>
            </div>
          ...
          <div className="relative my-4">
            ...
            <div className="relative flex justify-center text-xs"><span className="bg-white px-2 text-slate-400 font-medium">Ou experimente sem usar dados reais</span></div>
          </div>
          ...
          <div className="text-center pt-2">
            <p className="text-xs text-slate-500">
              ...
              <Link to="/register" className="text-primary-600 font-bold hover:underline">Cadastre-se grátis</Link>
            </p>
          </div>
        </CardContent>
      </Card>
