    ...
    <div className="min-h-screen bg-slate-900 text-white selection:bg-primary-500 selection:text-white">
      <nav className="border-b border-slate-800 bg-slate-900/80 backdrop-blur-md sticky top-0 z-50 px-4 sm:px-8 py-4 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <span className="font-extrabold text-base tracking-tight text-white block leading-tight">Konnexy OS Auto</span>
            <span className="text-[10px] text-primary-400 font-bold uppercase tracking-wider">Gestão Automotiva Inteligente</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Button variant="primary" size="sm" onClick={openDemo} rightIcon={<ArrowRight className="w-4 h-4" />}>
            Testar Agora
          </Button>
        </div>
      </nav>
      ...
      <section className="py-16 bg-slate-850 border-t border-slate-800 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h2 className="text-xs font-bold text-primary-400 uppercase tracking-wider mb-2">Fluxo Sem Fricção</h2>
            <p className="text-2xl sm:text-3xl font-extrabold text-white">Do orçamento ao pós-venda em poucos cliques</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-slate-900 p-6 rounded-2xl border border-slate-800 shadow-card">
              ...
              <p className="text-sm text-slate-400 leading-relaxed">
                O orçamento aprovado vira OS automaticamente. Acompanhe pelo quadro da oficina: entrada, diagnóstico, execução e entrega.
              </p>
            </div>
            ...
            <div className="bg-slate-900 p-6 rounded-2xl border border-slate-800 shadow-card">
              ...
              <p className="text-sm text-slate-400 leading-relaxed">
                Gere cobrança Pix, registre pagamentos, acompanhe a entrega e mantenha lembretes para futuras revisões e trocas de óleo.
              </p>
            </div>
          </div>
        </div>
